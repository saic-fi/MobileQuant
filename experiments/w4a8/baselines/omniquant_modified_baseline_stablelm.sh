...
CUDA_VISIBLE_DEVICES=0 python ptq/smoothquant.py --hf_path checkpoints/baselines/stablelm-2-1_6b --alpha 0.6
...
OUTPUT_DIR=results/stablelm-2-1_6b-omniquant-ours-w4a8
BATCH_SIZE=1
LET_LR=1e-3
LET_MIN_LR=5e-4
LWC_LR=5e-3
