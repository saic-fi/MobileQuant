...
CUDA_VISIBLE_DEVICES=0 python ptq/smoothquant.py --hf_path checkpoints/baselines/llama-1.1b --original_omniquant --alpha 0.5
...
OUTPUT_DIR=results/llama-1.1b-omniquant-orig-w4a8
BATCH_SIZE=1
LET_LR=1e-3
LET_MIN_LR=1e-4
LWC_LR=1e-3
